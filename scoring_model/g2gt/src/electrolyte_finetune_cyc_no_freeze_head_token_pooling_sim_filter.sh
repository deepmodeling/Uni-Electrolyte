...
if [[ $1 = "be" ]]; then
    ...
    --ID_name EP\ ID \
    --sigmoid_inf -5  --sigmoid_sup 1    --seed $2 --epoch 500
    ...
    --log_name_prefix  rem_electrolyte_train_1_CHO_47371_uninf_20230706 \
    --ID_name EP\ ID \
    --sigmoid_inf -18  --sigmoid_sup 3   --seed $2 --epoch 500
    ...
    --log_name_prefix  rem_electrolyte_train_1_CHO_47371_uninf_20230706 \
    --ID_name EP\ ID \
  --sigmoid_inf -8  --sigmoid_sup 13     --seed $2 --epoch 500
    ...
    --log_name_prefix  rem_electrolyte_train_1_CHO_47371_uninf_20230706 \
    --ID_name EP\ ID \
  --sigmoid_inf -0.5  --sigmoid_sup 2.5  --seed $2 --epoch 500
    ...
    --log_name_prefix  rem_electrolyte_train_1_CHO_47371_uninf_20230706 \
    --ID_name EP\ ID \
  --sigmoid_inf -4  --sigmoid_sup 3   --seed $2 --epoch 500
