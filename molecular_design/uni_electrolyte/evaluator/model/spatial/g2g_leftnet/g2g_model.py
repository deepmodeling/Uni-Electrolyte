...
class Embedding_extractor(pl.LightningModule):
    def __init__(self, n_layers,head_size,hidden_dim,attention_dropout_rate,dropout_rate,
                 intput_dropout_rate,weight_decay,ffn_dim,):
        super().__init__()
        ...
        self.ptm = GraphFormer.load_from_checkpoint(
            ...
            intput_dropout_rate=intput_dropout_rate,
    ...
    def predict_step(self, batch, batch_idx):
        ...
        self.predict_outputs_dict["ID"] += list(batch.EP_ID)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.test_outputs_dict["ID"]+=list(batch.EP_ID)
