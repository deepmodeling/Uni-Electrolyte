...
def generate(config: DictConfig, model):
    ...
    original_conditions = config.original_conditions
        ...
        for i in tqdm(range(n_batches)):
            ...
            with torch.no_grad():
                ...
                for idx, n_atoms in finished_list:
                    ...
                    ats += [at]
                    con.write(at, data=OmegaConf.to_container(config.settings.conditions, resolve=True))
