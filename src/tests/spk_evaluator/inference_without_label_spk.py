...
from uni_electrolyte.evaluator.trainer import ModelOutput, spk_inference_without_label
...
if __name__ == "__main__":
    workbase = r'./inference_without_label_output'
    ...
    task = spk_inference_without_label(
        model=nnpot,
        outputs=[output_U0],
