...
class spk_thuEMolGen(GenerativeAtomsDataModule):
    ...
    def prepare_data(self):
        if not os.path.exists(self.datapath):
            property_unit_dict = {
                spk_thuEMolGen.A: "GHz",
                spk_thuEMolGen.B: "GHz",
                spk_thuEMolGen.C: "GHz",
                spk_thuEMolGen.mu: "D",
                spk_thuEMolGen.alpha: "a0^3",
                spk_thuEMolGen.homo: "Ha",
                spk_thuEMolGen.lumo: "Ha",
                spk_thuEMolGen.gap: "Ha",
                spk_thuEMolGen.r2: "a0^2",
                spk_thuEMolGen.zpve: "Ha",
                spk_thuEMolGen.U0: "Ha",
                spk_thuEMolGen.U: "Ha",
                spk_thuEMolGen.H: "Ha",
                spk_thuEMolGen.G: "Ha",
                spk_thuEMolGen.Cv: "cal/mol/K",
            }
    ...
    def _download_atomrefs(self, tmpdir):
        ...
        props = [spk_thuEMolGen.zpve, spk_thuEMolGen.U0, spk_thuEMolGen.U, spk_thuEMolGen.H, spk_thuEMolGen.G, spk_thuEMolGen.Cv]
    ...
    def _download_data(
        ...
        irange = np.arange(len(ordered_files))
        if uncharacterized is not None:
            irange = np.setdiff1d(irange, np.array(uncharacterized) - 1)
